...
type DentflowApi = {
  machines: {
    ...
    reservationReminders: (actorUserId: number) => Promise<Array<{id:number;machineId:number;machineName:string;clinicId:number;clinicName:string;clinicCode:string;scheduledStartAt:string;scheduledEndAt:string;moverUserId:number;moverName:string;createdByUserId:number;createdByName:string|null;status:string;overrideReason:string}>>;
