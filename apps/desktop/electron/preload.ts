...
const dentflowApi = {
  machines: {
    ...
    updateReservation: (id: number, input: unknown, actorUserId: number) => ipcRenderer.invoke("machines:update-reservation", id, input, actorUserId),
    cancelReservation: (id: number, reason: string, actorUserId: number) => ipcRenderer.invoke("machines:cancel-reservation", id, reason, actorUserId),
