...
>>>>>>> Stashed changes
   ...
   * 術後實際使用。
   *
   * 這一步才選擇真正的 inventoryItemId，
   * 因此這一步才會確定 REF / LOT 並扣除實際批次庫存。
   */
  ipcMain.handle(
